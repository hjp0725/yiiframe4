    ...
    public static function getFormatTime($type, $start_time = '', $end_time = '')
    {
        switch ($type) {
            ...
            case 'last3Year' :   // 近三年
                ...
                list($time, $format) = [
                    [
                        'start' => mktime(0, 0, 0, 1, 1, $y - 2), // 三年前 1 月 1 日 00:00
                        'end'   => mktime(23, 59, 59, 12, 31, $y),  // 今年 12 月 31 日 23:59
                    ],
                    'month'
                ];
                break;
            ...
            case 'last5Year' :   // 近五年
                ...
                list($time, $format) = [
                    [
                        'start' => mktime(0, 0, 0, 1, 1, $y - 4), // 五年前 1 月 1 日 00:00
...
//                ],
    ...
    {
        list($data) = call_user_func($function, $time['start'], $time['end']);
