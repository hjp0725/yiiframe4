...
class m210817_163345_backend_member extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%backend_member}}', [
            ...
            'title' => "varchar(10) NULL DEFAULT '' COMMENT '真实姓名'",
        ...
        /* 表数据 */
        $this->insert('{{%backend_member}}',['id'=>'1','merchant_id'=>'0','department_id'=>'0','role_id'=>'0','username'=>'admin','password_hash'=>'$2y$13$z4MYqzq3khd5V75KjQM6e.3hLB9/qVSdl1uWB5W9W4MbR4XJzELpi','auth_key'=>'z6lrwixmdNF4VqtkXw6z-3vMZdSdngm2','password_reset_token'=>'','type'=>'10','title'=>'YiiFrame','head_portrait'=>'','gender'=>'1','qq'=>'','email'=>'','birthday'=>'2020-01-01','province_id'=>'230000','city_id'=>'230300','area_id'=>'230302','address'=>'','mobile'=>'18986860000','home_phone'=>'','dingtalk_robot_token'=>'','visit_count'=>'126','last_time'=>'1629213270','last_ip'=>'::1','role'=>'10','status'=>'1','created_at'=>'1449114934','updated_at'=>'1629213270']);
