...
class m210817_163345_rbac_auth_item extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%rbac_auth_item}}', [
            ...
            'addons_name' => "varchar(255) NULL DEFAULT '' COMMENT '插件名称'",
            ...
            'tree' => "varchar(255) NULL DEFAULT '' COMMENT '树'",
        ...
        $this->insert('{{%rbac_auth_item}}',['id'=>'46','name'=>'/base/department/ajax-edit','title'=>'编辑','app_id'=>'backend','addons_name'=>'','pid'=>'7','level'=>'3','is_addon'=>'0','sort'=>'1','tree'=>'tr_0 tr_38 tr_7 ','status'=>'1','created_at'=>'1582376900','updated_at'=>'1616341724']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'47','name'=>'/base/department/delete','title'=>'删除','app_id'=>'backend','addons_name'=>'','pid'=>'7','level'=>'3','is_addon'=>'0','sort'=>'2','tree'=>'tr_0 tr_38 tr_7 ','status'=>'1','created_at'=>'1582376900','updated_at'=>'1616341724']);
        /* 设置外键约束 */
