...
class m210817_163345_common_menu extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%common_menu}}', [
            ...
            'addons_name' => "varchar(255) NOT NULL DEFAULT '' COMMENT '插件名称'",
            ...
            'url' => "varchar(255) NULL DEFAULT '' COMMENT '路由'",
            ...
            'tree' => "varchar(255) NOT NULL DEFAULT '' COMMENT '树'",
        ...
        $this->insert('{{%common_menu}}',['id'=>'9','title'=>'部门管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'/base/department/index','icon'=>'fa-university','level'=>'1','dev'=>'0','sort'=>'2','params'=>'"[]"','tree'=>'tr_0 ','status'=>'1','created_at'=>'1617449954','updated_at'=>'1617450104']);
